...
readonly CMD_LINE_TOOLS_URL="https://dl.google.com/android/repository/commandlinetools-mac-10406996_latest.zip"
readonly SDK_MANAGER=sdk-tools-linux/cmdline-tools/latest/bin/sdkmanager
readonly FLUTTER_URL="https://storage.googleapis.com/flutter_infra_release/releases/stable/macos/flutter_macos_arm64_3.0.5-stable.zip"
...
export PATH=$PWD/sdk-tools-linux/platform-tools/:$PATH
